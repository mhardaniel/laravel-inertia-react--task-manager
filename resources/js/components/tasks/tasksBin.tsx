...
export default function TasksBin({ task }: { task: Task; }) {
      ...
      <div className="p-6 flex space-x-2">
        <div className="flex-1">
          <div className="flex justify-between items-center">
            ...
            {task.user.id === auth.user.id && !task.parent_id && (
              <DropdownMenu>
                ...
                <DropdownMenuContent >
                  <DropdownMenuItem asChild>
                    <Link className="w-full" method="delete" href={route('tasks.forceDestroy', task.id)} as="button">Permanently Delete</Link>
                  </DropdownMenuItem>
                </DropdownMenuContent>
              </DropdownMenu>
            )}
          ...
          <div className="mt-4 flex items-center gap-4">
            ...
            <span className="px-4 py-2 font-semibold text-sm text-white rounded-full shadow-sm" className={cn('px-4 py-2 text-sm text-white rounded-md shadow-sm',
              {
